...
import com.neverleave0916.farmin.ui.record.recordview2;
...
public class CAdapter extends RecyclerView.Adapter<CAdapter.MyViewHolder> {
    ...
    public CAdapter(Context mContext, List lst){
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.display_item3,parent,false);
        // click listener here
